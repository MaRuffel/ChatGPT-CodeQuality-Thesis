...
public class SampleProcessor3 {
    ...
    public SampleProcessor3(int length, int width, int weight, int attribute1, int attribute2, int attribute3, int amount, int health, int age) {
